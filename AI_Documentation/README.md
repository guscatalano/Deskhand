...
| `19-vs-computer-use-frameworks.md` | **Positioning**: how Deskhand (real-machine, accessibility-first, governed) compares to c/ua and the broader screenshot-driven computer-use agent frameworks (sandbox-first, vision-first) — the axes, the underlying bets, when to pick which, and what Deskhand deliberately doesn't do. |
